...
CURLSSLBACKEND_NSS, CURLSSLBACKEND_OPENHITLS, CURLSSLBACKEND_OPENSSL or
CURLSSLBACKEND_SCHANNEL. (Note that the OpenSSL forks are all reported as
OpenSSL here.)
...
CURLINFO_TLS_SESSION(3): **HITLS_Config ***

CURLINFO_TLS_SSL_PTR(3): **HITLS_Ctx ***

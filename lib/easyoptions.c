...
const struct curl_easyoption Curl_easyopts[] = {
  ...
  { "TLCP_ENC_CERT", CURLOPT_TLCP_ENC_CERT, CURLOT_STRING, 0 },
  { "TLCP_ENC_KEY", CURLOPT_TLCP_ENC_KEY, CURLOT_STRING, 0 },
  { "TLCP_ENC_KEYPASSWD", CURLOPT_TLCP_ENC_KEYPASSWD, CURLOT_STRING, 0 },

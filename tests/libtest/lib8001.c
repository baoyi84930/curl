...
static CURLcode test_lib8001(const char *URL)
{
  ...
  easy_setopt(curl, CURLOPT_TLCP_ENC_KEYPASSWD, NULL);

  /* Test setting empty string */
  easy_setopt(curl, CURLOPT_TLCP_ENC_KEYPASSWD, "");

  easy_setopt(curl, CURLOPT_SSL_CIPHER_LIST,
